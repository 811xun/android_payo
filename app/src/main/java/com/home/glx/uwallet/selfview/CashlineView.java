...
public class CashlineView extends View {
    ...
    public CashlineView(Context context) {
        this(context,null);
    }

    public CashlineView(Context context, AttributeSet attrs) {
        super(context, attrs);
        ...
        dashOrientation = typedArray.getInteger(R.styleable.DashView_dashOrientation,ORIENTATION_HORIZONTAL);
        mPaint.setColor(lineColor);
        mPaint.setStrokeWidth(lineHeight);
        typedArray.recycle();
    }

    public CashlineView(Context context, AttributeSet attrs, int lineColor) {
        super(context, attrs);
        TypedArray typedArray = context.obtainStyledAttributes(attrs, R.styleable.DashView);
        dashWidth = typedArray.getDimension(R.styleable.DashView_dashWidth,DEFAULT_DASH_WIDTH);
        lineHeight = typedArray.getDimension(R.styleable.DashView_lineHeight, DEFAULT_LINE_HEIGHT);
