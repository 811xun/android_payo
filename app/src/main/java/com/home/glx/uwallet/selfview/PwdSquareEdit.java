 ...
 */
public class PwdSquareEdit extends AppCompatEditText {
    ...
    public PwdSquareEdit(Context context) {
        super(context);
    ...
    public PwdSquareEdit(Context context, AttributeSet attrs) {
        super(context, attrs);
        mC = context;
        setAttrs(attrs);
        init();
    ...
    public PwdSquareEdit(Context context, AttributeSet attrs, int defStyleAttr) {
