...
public class GetBankList_m implements GetBankList_in.Model {

    private Context context;
    private GetBankList_p present;

    public GetBankList_m(Context context, GetBankList_p present) {
        this.context = context;
        this.present = present;
    }

    @Override
    public void getBankList(Map<String, Object> maps) {
        RequestUtils requestUtils1 = new RequestUtils(context, maps, new RequestUtils.RequestDataStr() {
            ...
            public void topData(RequestUtils requestUtils, RequestInterface requestInterface,
                ...
                Call<ResponseBody> call = requestInterface.getCardList(headerMap, id, requestBody);
                requestUtils.Call(call);
            }

            @Override
            public void resData(String dataStr, String pc, String code) {
                present.resBankList(dataStr);
            }


            @Override
            public void resError(String error) {
                present.resBankList(null);
            }
        });
    }
}
