 ...
 */
public class PwdEditText_6digital extends AppCompatEditText {
    ...
    public PwdEditText_6digital(Context context) {
        super(context);
    ...
    public PwdEditText_6digital(Context context, AttributeSet attrs) {
        super(context, attrs);
        mC = context;
        setAttrs(attrs);
        init();
    ...
    public PwdEditText_6digital(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    protected void onDraw(Canvas canvas) {
        ...
        int borderColor = ContextCompat.getColor(getContext(), R.color.black);
        int borderWidth = 5;
