...
import com.home.glx.uwallet.adapter.SelctBankListAdapter_zhifu;
...
public class Zhifu_SelectBankCardActivity extends MainActivity implements GetChoiceList_in.View {//xzc 复制的SelectBankCardActivity
    private RecyclerView recyclerView;
    private UserListener userListener;
    private KycAndIllionListener kycAndIllionListener;
    private List<BankDatas> cardLists;
    private SelctBankListAdapter_zhifu adapter;
    ...
    public int getLayout() {
        return R.layout.activity_select_bank_card_zhifu;
    }
...
//                    next.setVisibility(View.VISIBLE);
        ...
        next.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (choiceData != null) {
                    if (fromPay == 1) {
                        Intent intent = Zhifu_SelectBankCardActivity.this.getIntent();
                        ...
                        bundle.putString("shijicardNo", choiceData.getCardNo().replaceAll(" ", ""));//添加要返回给页面1的数据
                        bundle.putString("cardId", choiceData.getId());//添加要返回给页面1的数据
                        intent.putExtras(bundle);
                        Zhifu_SelectBankCardActivity.this.setResult(Activity.RESULT_OK, intent);//返回页面1
                        Zhifu_SelectBankCardActivity.this.finish();
                        ...
                        kycAndIllionListener.setDefaultCard(map, new ActionCallBack() {
                            ...
                            public void onSuccess(Object... o) {
                                TiShiDialog tiShiDialog = new TiShiDialog(Zhifu_SelectBankCardActivity.this);
                                tiShiDialog.setOnGuanBi(new TiShiDialog.GuanBi() {
                                    @Override
                                    public void GuanBi() {
//                                        Intent intent = new Intent(Zhifu_SelectBankCardActivity.this, FenQiFuOpen_Activity.class);
...
//                                        startActivity(intent);
    ...
    private void getPayAmount() {
        ...
        payListener.getPayTransAmountDetail(requestMap, new ActionCallBack() {
            ...
            public void onSuccess(Object... o) {
                ...
                Intent intent = new Intent(Zhifu_SelectBankCardActivity.this, PayMoneyActivity.class);
    ...
    public void setBankList(List<BankDatas> list) {
        ...
        cardLists = list;
        if (adapter == null) {
            adapter = new SelctBankListAdapter_zhifu(this, list, selectCardId);
            recyclerView.setAdapter(adapter);
            adapter.setOnitemClick(new SelctBankListAdapter_zhifu.OnitemClick() {
                @Override
...
//                    }
                ...
                public void addCard() {
                    ...
                    Intent intent = new Intent(Zhifu_SelectBankCardActivity.this, NewAddBankCardActivity.class);
                    intent.putExtra("fromSelectZhifuList", 1);
...
//            getBankList();
            ...
            Intent intent = Zhifu_SelectBankCardActivity.this.getIntent();
            Bundle bundle = intent.getExtras();
            String cardN = data.getStringExtra("cardNo");
            cardN = "•••• " + cardN.substring(cardN.length() - 4);
            bundle.putString("cardNo", cardN);//添加要返回给页面1的数据
            bundle.putString("cardId", data.getStringExtra("cardId"));//添加要返回给页面1的数据
            intent.putExtras(bundle);
            Zhifu_SelectBankCardActivity.this.setResult(Activity.RESULT_OK, intent);//返回页面1
            Zhifu_SelectBankCardActivity.this.finish();
        }
    ...
    class MyClickableSpan extends ClickableSpan {
        ...
        public void onClick(View widget) {
            ...
            intent.setClass(Zhifu_SelectBankCardActivity.this, PdfActivity.class);
