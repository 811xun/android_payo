package com.home.glx.uwallet.selfview.choicetime.wheelview;
...
import com.home.glx.uwallet.selfview.choicetime.wheelview.adapter.WheelViewAdapter;
...
public class WheelView extends View {
	...
	//*/
    private int[] SHADOWS_COLORS = new int[]{0xFFF0F0F0, 0x00F0F0F0, 0x00F0F0F0};
    ...
    private int wheelForeground_meiyourunajiao = R.drawable.wheel_val_meiyouyuanjiao;
    private boolean hasYuanjiao = false;
    // Shadows drawables
    ...
    public void hasYuanjiao(boolean hasYuanjiao) {
        this.hasYuanjiao = hasYuanjiao;
    }
    ...
    public void setWheelForeground(int resource) {
        ...
        if (hasYuanjiao) {
            ...
            centerDrawable = getContext().getResources().getDrawable(wheelForeground_meiyourunajiao);
        }
    }
    ...
    private void initResourcesIfNecessary() {
        ...
        setBackgroundResource(wheelBackground);
//        setBackground(ContextCompat.getDrawable(mContext,wheelBackground));
    }
...
//		int offset = 60;
        //Remarked by wulianghuan 2014-11-27  使用自己的画框，而不是描边
        ...
        paint.setColor(getResources().getColor(R.color.bj));
        // 设置线宽
