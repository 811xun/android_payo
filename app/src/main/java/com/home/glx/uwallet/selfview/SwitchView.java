...
public class SwitchView extends View {
    ...
    public SwitchView(Context context, AttributeSet attrs) {
        ...
        colorBackground = a.getColor(R.styleable.SwitchView_bgColor, 0xFFD4D7DD);
    ...
    public interface OnStateChangedListener {
        void toggleToOn(com.home.glx.uwallet.selfview.SwitchView view);

        void toggleToOff(com.home.glx.uwallet.selfview.SwitchView view);
    }

    private OnStateChangedListener listener = new OnStateChangedListener() {
        @Override
        public void toggleToOn(com.home.glx.uwallet.selfview.SwitchView view) {
            toggleSwitch(true);
        }

        @Override
        public void toggleToOff(com.home.glx.uwallet.selfview.SwitchView view) {
            toggleSwitch(false);
        }
    };
