...
public class SeparatedEditText extends AppCompatEditText {
    ...
    public SeparatedEditText(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        password = ta.getBoolean(R.styleable.SeparatedEditText_p_password, false);
        showCursor = ta.getBoolean(R.styleable.SeparatedEditText_p_showCursor, true);
        borderColor = ta.getColor(R.styleable.SeparatedEditText_p_borderColor, ContextCompat.getColor(getContext(), R.color.black));
        blockColor = ta.getColor(R.styleable.SeparatedEditText_p_blockColor, ContextCompat.getColor(getContext(), R.color.colorPrimary));
        textColor = ta.getColor(R.styleable.SeparatedEditText_p_textColor, ContextCompat.getColor(getContext(), R.color.lightGrey));
        cursorColor = ta.getColor(R.styleable.SeparatedEditText_p_cursorColor, ContextCompat.getColor(getContext(), R.color.lightGrey));
        corner = (int) ta.getDimension(R.styleable.SeparatedEditText_p_corner, 0);
        spacing = (int) ta.getDimension(R.styleable.SeparatedEditText_p_blockSpacing, 0);
        type = ta.getInt(R.styleable.SeparatedEditText_p_separateType, TYPE_UNDERLINE);
        maxLength = ta.getInt(R.styleable.SeparatedEditText_p_maxLength, 6);
        cursorDuration = ta.getInt(R.styleable.SeparatedEditText_p_cursorDuration, 400);
        cursorWidth = (int) ta.getDimension(R.styleable.SeparatedEditText_p_cursorWidth, 2);
        borderWidth = (int) ta.getDimension(R.styleable.SeparatedEditText_p_borderWidth, 5);
    ...
    private void drawRect(Canvas canvas) {
        for (int i = 0; i < maxLength; i++) {
            ...
            boxRectF.set(spacing * (i + 1) + boxWidth * i + 10, 0,
                    spacing * (i + 1) + boxWidth * i + boxWidth - 10,
                    boxHeight);

            if (type == TYPE_SOLID) {
                //绘制输入框
                canvas.drawRoundRect(boxRectF, corner, corner, blockPaint);
                canvas.drawRoundRect(boxRectF, corner, corner, borderPaint);
