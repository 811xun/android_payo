 ...
 */
package com.home.glx.uwallet.selfview.choicetime.wheelview.adapter;
...
public abstract class AbstractWheelTextAdapter1 extends AbstractWheelAdapter {
    ...
    protected AbstractWheelTextAdapter1(Context context, int itemResource, int itemTextResource, int currentIndex,
                                        int maxsize, int minsize, boolean showCircleImage) {
        this.context = context;
        itemResourceId = itemResource;
        itemTextResourceId = itemTextResource;
        this.currentIndex = currentIndex;
    ...
    public View getItem(int index, View convertView, ViewGroup parent) {
        if (index >= 0 && index < getItemsCount()) {
            ...
            ImageView circle_image = convertView.findViewById(R.id.circle_image);
            ...
            if (text.toString().equals("RHCA")) {
                circle_image.setVisibility(View.VISIBLE);
                Drawable up = ContextCompat.getDrawable(context, R.mipmap.blue_circle);
                Drawable drawableUp = DrawableCompat.wrap(up);
                DrawableCompat.setTint(drawableUp, ContextCompat.getColor(context, R.color.color_c9dd00));
                circle_image.setImageDrawable(drawableUp);
            } else if (text.toString().equals("Australian Resident")) {
                circle_image.setVisibility(View.VISIBLE);
                Drawable up = ContextCompat.getDrawable(context, R.mipmap.blue_circle);
                Drawable drawableUp = DrawableCompat.wrap(up);
                DrawableCompat.setTint(drawableUp, ContextCompat.getColor(context, R.color.color_268656));
                circle_image.setImageDrawable(drawableUp);
            } else if (text.toString().equals("Interim")) {
                circle_image.setVisibility(View.VISIBLE);
                Drawable up = ContextCompat.getDrawable(context, R.mipmap.blue_circle);
                Drawable drawableUp = DrawableCompat.wrap(up);
                DrawableCompat.setTint(drawableUp, ContextCompat.getColor(context, R.color.color_45b9d5));
                circle_image.setImageDrawable(drawableUp);
            } else {
