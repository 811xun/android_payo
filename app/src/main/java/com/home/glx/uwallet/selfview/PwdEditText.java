 ...
 */
public class PwdEditText extends AppCompatEditText {//画一条长的横线
    ...
    private void setAttrs(AttributeSet attrs) {
        ...
        if (t != null) {
            ...
            textColor = t.getColor(R.styleable.PwdEditText_textColor, 0xFF717171);
    ...
    protected void onTextChanged(CharSequence text, int start, int lengthBefore, int lengthAfter) {
        ...
        Log.d("xslsllsl", "onTextChanged: " + text.toString());
    ...
    protected void onDraw(Canvas canvas) {
        ...
        borderPaint.setColor(waitInputColor);
        ...
        for (int i = 0; i < textLength; i++) {
            ...
            RectF rect = null;
            if (i == 0) {//xzc P码设置页面
                Log.d("ddddddd", "onDraw: " + dp2px(27));//xzc测试机81
                rect = new RectF(i * Wide + dp2px(27), spzceY, i * Wide + Wide, Wide - spzceY); //四个值，分别代表4条线，距离起点位置的线
            } else if (i == textLength - 1) {
                rect = new RectF(i * Wide, spzceY, i * Wide + Wide - dp2px(27), Wide - spzceY); //四个值，分别代表4条线，距离起点位置的线
            } else {
                rect = new RectF(i * Wide, spzceY, i * Wide + Wide, Wide - spzceY); //四个值，分别代表4条线，距离起点位置的线
        ...
        for (int j = 0; j < mText.length(); j++) {
            if (isPwd) {
                if (j == 2 || j == 3) {
                    canvas.drawCircle(rectFS.get(j).centerX() - dp2px(27)/2, rectFS.get(j).centerY(), Circle, textPaint);
                } else {
